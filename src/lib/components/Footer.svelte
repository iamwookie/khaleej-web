...
<footer class="bg-base-300 w-full">
	<div class="footer container p-10">
		...
		<nav class="grid-flow-col gap-4 place-self-center md:justify-self-end">
			...
			<a href="/" aria-label="YouTube" class="hover:opacity-50 transition-opacity">
			...
			<a href="/" aria-label="Twitter" class="hover:opacity-50 transition-opacity">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current">
					<path
